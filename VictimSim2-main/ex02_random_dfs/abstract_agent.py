...
class AbstAgent:
    ...
    AC_INCR = {
        'UP': (0, -1),  # u: Up
        'UP-RIGHT': (1, -1),  # ur: Upper right diagonal
        'RIGHT': (1, 0),  # r: Right
        'DOWN-RIGHT': (1, 1),   # dr: Down right diagonal
        'DOWN': (0, 1),  # d: Down
        'DOWN-LEFT': (-1, 1),  # dl: Down left left diagonal
        'LEFT': (-1, 0),  # l: Left
        'UP-LEFT': (-1, -1)  # ul: Up left diagonal
    }
    ...
    def __init__(self, env, config_file):
        ...
        # public: time limit to execute (cannot be exceeded)
        self.TLIM = 0.0
        ...
        # public: basic cost to drop the first aid package to a victim
        self.COST_FIRST_AID = 0.0
        self.COLOR = (100, 100, 100)  # public: color of the agent
        # public: color for the visited cells
