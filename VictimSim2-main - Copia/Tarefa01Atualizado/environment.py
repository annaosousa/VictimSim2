...
class Env:
    ...
    def __print_victims(self, victims, type_str, sub, ident=3):
        ...
        if len(victims) > 0:
            ...
            print(f"{idents}{sev.count(1)},{sev.count(2)},{
                  sev.count(3)},{sev.count(4)},{weighted}")
        else:
    ...
    def print_acum_results(self):
        ...
        print(f"   {self.severity.count(1)},{self.severity.count(2)},{
              self.severity.count(3)},{self.severity.count(4)},{self.sum_gravity}")
